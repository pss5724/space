	...
	<div class="mypage_content">
			...
			<div class="mypage_right_box">
				...
				<form id="review_write" action="mypage_review_write_proc.do" method="post">
					...
					<input type="hidden" value="${revo.rsid }" name="rsid">
				...
				<table class="mypage_right_box_table_review">
						...
						<tr>
							<th>내용</th>
							<td colspan="5"><textarea name="rcontent" class="rcontent"></textarea></td>
						</tr>
			...
			<button type="button" class="review_write_btn">작성</button>
		</div>
		</form>
			</div>
			<!-- right box end -->
